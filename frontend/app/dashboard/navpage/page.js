...
export default function VotingPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-900 flex">
      ...
      <div className="w-1/4 bg-gray-800 p-6 space-y-6">
      ...
      <div className="w-3/4 flex items-center justify-center p-6">
        <div className="w-full max-w-lg bg-gray-800 rounded-xl shadow-xl p-8 space-y-8">
          ...
          <div className="flex justify-between text-sm text-gray-400">
            <p>Your Voting Power: <span className="font-medium">{user.votingPower}</span></p>
            <p>Total Voting Power: <span className="font-medium">{user.totalPower}</span></p>
          </div>
          {!submitted ? (
            ...
            <div className="text-center space-y-4">
              <h2 className="text-2xl font-semibold text-white">🎉 Thanks for Voting!</h2>
